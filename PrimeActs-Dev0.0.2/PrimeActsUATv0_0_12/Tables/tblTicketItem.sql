...
CREATE NONCLUSTERED INDEX [IX_tblTicketItem_ConsignmentItemID]
    ON [dbo].[tblTicketItem]([ConsignmentItemID] ASC, [TicketID] ASC, [TicketItemQuantity] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tblTicketItem_TicketIDTicketItemID]
    ON [dbo].[tblTicketItem]([TicketID] ASC, [TicketItemID] ASC);
