...
{
    public partial class Note : PrimeActs.Domain.Abstract.AbstractObjectState, PrimeActs.Infrastructure.BaseEntities.IObjectState
    {
        public Note()
        {
        ...
        public System.Guid NoteAuthor { get; set; }
        public System.DateTime NoteCreated { get; set; }
        public System.DateTime NoteAmended { get; set; }
