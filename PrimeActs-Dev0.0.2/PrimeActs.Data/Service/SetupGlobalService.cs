...
{
    public class SetupGlobalService : Service<SetupGlobal>, ISetupGlobalService
    {
        private readonly IRepositoryAsync<SetupGlobal> _repository;

        public SetupGlobalService(IRepositoryAsync<SetupGlobal> repository)
            : base(repository)
        {
            _repository = repository;
        }
        public List<SetupGlobal> GetAllSetupValuesBySetupName(string mySetupName)
        {
            List<SetupGlobal> AlSetupValues = _repository.Query(x => x.SetupName== mySetupName).Select().ToList();
            return AlSetupValues;
        }
