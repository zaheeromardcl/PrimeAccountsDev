...
{
    [Authorize]
    public class ManageController : PrimeActsController
    {
        ...
        public ManageController(PrimeActsUserManager userManager, PrimeActsSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            var result =
                await
                    UserManager.RemoveLoginAsync(Guid.Parse(User.Identity.GetUserId()),
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            var code =
                await
                    UserManager.GenerateChangePhoneNumberTokenAsync(Guid.Parse(User.Identity.GetUserId()), model.Number);
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            var code =
                await
                    UserManager.GenerateChangePhoneNumberTokenAsync(Guid.Parse(User.Identity.GetUserId()), phoneNumber);
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            var result =
                await
                    UserManager.ChangePhoneNumberAsync(Guid.Parse(User.Identity.GetUserId()), model.PhoneNumber,
                        model.Code);
            if (result.Succeeded)
            {
                var user = await UserManager.FindByIdAsync(Guid.Parse(User.Identity.GetUserId()));
        ...
        {
            return View(new ChangeResetPasswordViewModel());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangePassword(ChangeResetPasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        public async Task<ActionResult> SetPassword(SetPasswordViewModel model)
        {
            ...
            {
                var result =
                    await UserManager.AddPasswordAsync(Guid.Parse(User.Identity.GetUserId()), model.NewPassword);
                if (result.Succeeded)
                {
                    var user = await UserManager.FindByIdAsync(Guid.Parse(User.Identity.GetUserId()));
                    if (user != null)
